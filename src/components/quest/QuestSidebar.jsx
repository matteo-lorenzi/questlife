  ...
  return (
    <div className="w-44 flex-shrink-0 bg-white border-r border-gray-100 flex flex-col">
      ...
      <div className="p-2 space-y-1.5 flex-1">
        {TYPES.map(t => (
          <div key={t.type} draggable onDragStart={e => handleDragStart(e, t.type)}
            className="flex items-center gap-2.5 px-2.5 py-2.5 rounded-lg border cursor-grab active:cursor-grabbing transition-all duration-150 hover:shadow-sm select-none group"
      ...
      <div className="px-3 py-3 border-t border-gray-100">
        <p className="text-xs text-gray-300 leading-relaxed">Glisse un type sur le canvas.</p>
      </div>
    </div>
  )
}
